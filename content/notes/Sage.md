...
## Pneuma Opener
{{< figure src="/notes/images/SGE-Pneuma.png" link="/notes/images/SGE-Pneuma.png" class="center" width="90%" >}}

> This opener should only be used if you aren't going to be using Pneuma in the first 2 minutes of the fight - if either healer is needing to use a GCD heal to cover damage that could have been covered with Pneuma, don't use this opener.
